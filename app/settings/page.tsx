    ...
    <AppLayout user={user}>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8 py-12 text-white">
        <div className="mb-8">
          ...
          <p className="text-white/60">Manage notifications, privacy, and account preferences.</p>
        </div>
          ...
          <NeonCard className="p-6 border-white/10 bg-[#0A0A0A]">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">Control email and push alerts (coming soon).</p>
              </div>
            </div>
            <div className="text-sm text-white/40">Feature coming soon.</div>
          </NeonCard>
          ...
          <NeonCard className="p-6 border-white/10 bg-[#0A0A0A]">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-white/60">Manage downloads, model storage, and data removal.</p>
              </div>
            </div>
            <div className="text-sm text-white/40">We’ll add granular controls here.</div>
          </NeonCard>
        </div>
      </div>
    </AppLayout>
