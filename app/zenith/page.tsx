...
import { Send, Loader2, Bot, User, History, Plus, X } from 'lucide-react'
...
export default function ZenithPage() {
  ...
  return (
    <AppLayout user={user}>
      <div className="relative h-screen pt-20 overflow-hidden bg-gradient-to-b from-white to-gray-50 dark:from-[#0a0a0a] dark:to-[#0f0f0f]">
        <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-12 max-w-5xl h-full flex flex-col">
          {/* History Sidebar */}
          <AnimatePresence>
            {showHistory && (
              <>
                ...
                <motion.div
                  ...
                  className="fixed left-0 top-20 bottom-0 w-80 bg-white/95 dark:bg-[#0f0f0f]/95 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-800/50 z-50 shadow-2xl overflow-hidden flex flex-col"
                >
                  ...
                  <button
                    ...
                    className="m-4 px-4 py-2.5 rounded-xl bg-gradient-to-br from-neon-light to-blue-600 dark:from-neon-primary dark:to-green-500 text-white font-medium flex items-center gap-2 hover:opacity-90 transition-opacity shadow-lg shadow-neon-light/20 dark:shadow-neon-primary/20"
                  >
          ...
          <motion.div
            ...
            className="mb-8 flex-shrink-0 py-8"
          >
            <div className="flex items-center justify-between">
              <div className="flex-1 text-center">
                <h1 className="text-2xl md:text-3xl font-bold text-neon-light dark:text-neon-primary tracking-tight mb-2">
                  ZENITH
                </h1>
                <p className="text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium tracking-widest uppercase">
                  Your personal coach
                </p>
              </div>
              <div className="flex items-center gap-2">
                <button
                  onClick={createNewChat}
                  className="p-2.5 rounded-xl bg-white/80 dark:bg-[#1a1a1a]/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-800/50 hover:bg-gray-100/50 dark:hover:bg-gray-800/50 transition-all shadow-lg"
                  title="New Chat"
                >
                  <Plus className="w-5 h-5 text-neon-light dark:text-neon-primary" />
                </button>
                <button
                  ...
                  title="Chat History"
                >
                  <History className="w-5 h-5 text-neon-light dark:text-neon-primary" />
                </button>
              </div>
            </div>
          </motion.div>
          ...
          <div className="flex-1 flex flex-col min-h-0">
            {/* Messages */}
            <div ref={messagesContainerRef} className="flex-1 overflow-y-auto px-2 md:px-6 py-8 scroll-smooth">
              <AnimatePresence>
                {messages.map((message) => (
                  ...
                  >
                    <div
                      className={`max-w-[80%] md:max-w-[70%] rounded-3xl px-6 py-4 shadow-lg transition-all duration-200 ${
                        message.role === 'user'
            ...
            {/* Input Area */}
            <div className="border-t border-gray-200/50 dark:border-gray-800/50 bg-white/50 dark:bg-[#0a0a0a]/50 backdrop-blur-xl px-2 md:px-6 py-6">
              <form onSubmit={(e) => { e.preventDefault(); handleSend(); }} className="flex gap-4 items-end max-w-4xl mx-auto">
                ...
                <textarea
                  ...
                  rows={1}
                    style={{ minHeight: '56px', maxHeight: '120px', wordWrap: 'break-word', overflowWrap: 'break-word' }}
                  disabled={sending}
                />
                </div>
                <button
