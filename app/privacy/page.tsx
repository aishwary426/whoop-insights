            ...
            <div className="relative z-10 min-h-screen py-24 px-6 md:px-12">
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="text-center space-y-4">
                        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white">Privacy Policy</h1>
                        <p className="text-xl text-gray-600 dark:text-white/60">Your data stays where it belongs: on your device.</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Data Collection */}
                        <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-8 space-y-4">
                        ...
                        <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-8 space-y-4">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white">Model Training</h3>
                            <p className="text-gray-600 dark:text-white/60">
