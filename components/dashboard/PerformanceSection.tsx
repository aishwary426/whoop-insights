            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-12 space-y-4">
                    <motion.h2
                        ...
                        className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-blue-600 to-gray-500 dark:from-white dark:via-blue-100 dark:to-white/50 font-inter"
                    >
                        Performance
                    </motion.h2>
                    <motion.p
                        ...
                        className="text-xl text-blue-600/60 dark:text-blue-200/60 max-w-2xl mx-auto font-light tracking-wide font-inter"
                    >
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-8 max-w-5xl mx-auto w-full gap-6">
                    {/* View Switcher */}
                    <div className="flex bg-gray-100 dark:bg-white/5 backdrop-blur-md rounded-full p-1 border border-gray-200 dark:border-white/10">
                    ...
                    {/* Time Slider */}
                    <div className="flex items-center gap-4 bg-gray-100 dark:bg-white/5 backdrop-blur-md rounded-full px-6 py-3 border border-gray-200 dark:border-white/10">
                        <div className="flex items-center gap-2">
                            <Clock className="w-4 h-4 text-gray-400 dark:text-white/40" />
                            <span className="text-xs uppercase tracking-wider text-gray-400 dark:text-white/40 font-inter">Timeline</span>
                        </div>
                        <input
                            type="range"
                            min="0"
                    ...
                    <NeonCard className="w-full h-full bg-white/40 dark:bg-black/40 border-gray-200 dark:border-white/10 backdrop-blur-xl overflow-hidden relative group">
                        ...
                        <div className="absolute inset-0 p-6 md:p-10 flex flex-col">
                            <div className="flex justify-between items-start mb-6">
                                <div>
                                    <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-1 font-inter">
                                        {view === 'strain' && 'Strain Load'}
                                        {view === 'sleep' && 'Sleep Performance'}
                                        {view === 'compare' && 'Strain vs Sleep'}
                                    </h3>
                                    <p className="text-gray-400 dark:text-white/40 text-sm uppercase tracking-wider font-inter">Last {timeWindow} Days</p>
                                </div>
                                {/* Legend */}
                                        ...
                                        >
                                            ...
                                            {(view === 'strain' || view === 'compare') && (
                                                <Area
                                                    ...
                                                    activeDot={{ r: 6, fill: dotFill, stroke: '#22d3ee', strokeWidth: 3 }}
                                                />
                                            )}
                                            ...
                                            {(view === 'sleep' || view === 'compare') && (
                                                <Area
                                                    ...
                                                    activeDot={{ r: 6, fill: dotFill, stroke: '#a855f7', strokeWidth: 3 }}
                                                />
                                            )}
                                        </AreaChart>
                                    </ResponsiveContainer>
